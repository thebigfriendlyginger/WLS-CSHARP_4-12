<%@ Page Language="C#" AutoEventWireup="true" CodeFile="profile-confirmation.aspx.cs" Inherits="profile_confirmation" %>
  ...
  <section id="container" class="">
      ...
      <div class="row"> <!--START ROW INSTRUCTIONS-->
   		<div class="col-md-9"> <!--START COL INSTRUCTION-->
			<p class="confirmation-text"> Your changes have been saved!</p>
	   </div> <!--END COL INSYRUCTIONS-->
   
	</div> <!--END ROW INSTRUCTIONS-->
     
    <div class="row"> <!--START ROW EDIT BUTTON-->
     	<div class="col-md-6 col-md-offset-3"><!--START EDIT COL-->
     			<a href="edit-profile.aspx">
			<div class="profile-edit"><!--START DIV EDIT BUTTON-->
				<p>Edit</p>
				</div>  <!--END DIV EDIT BUTTON-->
			</a>
		</div> <!--END EDIT COL-->
      
	</div>  <!--END ROW EDIT BUTTON-->
                 ...
                 <div class=" col-md-9 col-lg-9 ">  <!--START COL MAIN TEXT-->
                  <table class="table table-user-information"> <!--TABLE USER INFO-->
                    ...
                    <tr>
                      <tr>
                        <td>Email</td>
                        <td><a href="mailto:samw@gmail.com">samw@gmail.com</a></td>
                      </tr>
                    </tr>
