<%@ Page Language="C#" AutoEventWireup="true" CodeFile="add-time.aspx.cs" Inherits="add_time" %>
...
<!--HOURS TIMESHEET-->				   
    ...
    <div class="col-md-6"><!--START COL TITLE-->
		<h3>Total Yearly Hours: <asp:Label ID="totalHours" runat="server"></asp:Label> </h3>
		</div> <!--END COL TITLE-->
		
	<div class="col-md-6"><!--START COL TITLE-->
		<div class="two-buttons">
			<div><!--START DIV EDIT BUTTON-->
				<asp:Button class="save-button" ID="btnSave" runat="server" Text="Save" OnClick="btnSave_Click"/>
  ...
  <div class="row"> <!--START ROW ADD TIME-->
                              ...
                              <tr>
                                <td>
                                 <div class="form-group">
   										<asp:TextBox runat="server" class="form-control" id="shiftDateToAdd" placeholder="01-01-2010"></asp:TextBox>
   								</div>
								  </td>
                                 <td>
                                  <div class="form-group">
   										<asp:TextBox runat="server" class="form-control" id="clockInTimeToAdd" placeholder="12:00 AM"></asp:TextBox>
								  </div>
								  </td>
                                 <td>
                                  <div class="form-group">
   										<asp:TextBox runat="server" class="form-control" id="clockOutTimeToAdd" placeholder="12:00 AM"></asp:TextBox>
								  </div>
								  </td>
                              </tr>
                              </tbody>
