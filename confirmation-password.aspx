<%@ Page Language="C#" AutoEventWireup="true" CodeFile="confirmation-password.aspx.cs" Inherits="confirmation_password" %>
  ...
  <section id="container" class="">
    ...
    <div class="row"> <!--START ROW INSTRUCTIONS-->
   		<div class="col-md-9"> <!--START COL INSTRUCTION-->
			<p class="confirmation-text"> Your new password has been saved!</p>
